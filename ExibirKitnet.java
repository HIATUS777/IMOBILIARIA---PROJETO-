 ...
 * @author aluno
 */
public class ExibirKitnet extends javax.swing.JFrame {

    /**
     * Creates new form ExibirKitnet
     */
    public ExibirKitnet() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projeto/img/Kitnet.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExibirKitnet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExibirKitnet().setVisible(true);
            }
        });
    }
