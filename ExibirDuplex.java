 ...
 * @author aluno
 */
public class ExibirDuplex extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projeto/img/Duplex.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(795, 609));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExibirDuplex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExibirDuplex().setVisible(true);
            }
        });
    }
