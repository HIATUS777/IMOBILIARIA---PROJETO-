 ...
 * @author aluno
 */
public class ExibirMansao extends javax.swing.JFrame {

    /**
     * Creates new form ExibirMansão
     */
    public ExibirMansao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projeto/img/Mansão.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExibirMansao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExibirMansao().setVisible(true);
            }
        });
    }
